...
Instructions for local installation of displays for mw dictionary.

 1.  Go to https://www.sanskrit-lexicon.uni-koeln.de/scans/MWScan/2020/web/webtc/download.html
       and download mwweb1.zip.
 1a. unzip mwweb1.zip. You need the  'web' folder,  which contains fonts, images, etc. 
 ...
 3. Find the 'home' folder for your server.
   ...
   Then create a folder named 'mw' under 'cologne'.
   Finally move the 'web' folder of step 1 into 'mw' folder.
   So we now have, in Windows xampp installation, 
     C:\xampp\htdocs\cologne\mw\web
...
1.  get a copy of the scanned images for mw
 1a.  make a directory named 'scans' as a child of the 'cologne' directory
 1b. cd into cologne/scans
 1c. git clone https://github.com/sanskrit-lexicon-scans/mw.git
     This will download a directory called 'mw' into cologne/scans folder.
     PDFs for individual pages are in the subfolder named 
     'cologne/scans/mw/pdfpages'
...
2.  Access a particular page (say page 123) via the browser with this url:
    http://localhost/cologne/mw/web/webtc/servepdf.php?page=123
3.  Also, in your mw displays,  clicking on a page link should now
